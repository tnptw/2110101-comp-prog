...
test = [
    ...
    #10
    "assert max_rain_in_3h_periods(data,'N','2021-04-06') == [(6, 6.94), (9, 4.49), (12, 0.35), (15, 0.1), (18, 0.25), (21, 0.67)]",
    #11
    "assert max_rain_in_3h_periods(data,'N','2021-04-07') == [(15, 0.33), (18, 0.36), (21, 0.36)]",
    #12
    "assert max_rain_in_3h_periods(data,'N','2021-04-08') == [(0, 1.31), (3, 0.12)]",
    #13
    "assert max_rain_in_3h_periods(data,'N','2021-04-09') == [(21, 0.12)]",
    #14
    "assert max_rain_in_3h_periods(data,'N','2021-04-10') == [(0, 0.21), (3, 0.13), (9, 0.38), (12, 6.95), (15, 2.88)]",
    #15
    "assert max_rain_in_3h_periods(data,'N','2021-04-11') == [(0, 0.27)]",
    #16
    "assert max_rain_in_3h_periods(data,'E','2021-04-06') == [(6, 4.23), (9, 1.83), (12, 1.37), (15, 0.94), (18, 0.48), (21, 3.43)]",
    #17
    ...
    #19
    "assert max_rain_in_3h_periods(data,'E','2021-04-09') == [(0, 3.62), (3, 3.34), (6, 1.5), (9, 0.7), (15, 0.56), (18, 0.49), (21, 3.14)]",
    #20
    "assert max_rain_in_3h_periods(data,'E','2021-04-10') == [(0, 4.01), (3, 1.82), (6, 1.06), (9, 0.96), (12, 0.47), (18, 1.29), (21, 1.57)]",
    #21
    "assert max_rain_in_3h_periods(data,'E','2021-04-11') == [(0, 2.37), (3, 2.61)]",
    #22
    "assert max_rain_in_3h_periods(data,'W','2021-04-06') == [(6, 0.9), (9, 0.24), (12, 0.66), (15, 3.8), (18, 3.24)]",
    #23
    "assert max_rain_in_3h_periods(data,'W','2021-04-07') == [(0, 0.1), (3, 0.49), (6, 0.33), (9, 0.41), (12, 10.68), (15, 13.35), (18, 3.66)]",
    #24
    "assert max_rain_in_3h_periods(data,'W','2021-04-08') == [(9, 0.91), (12, 16.38), (15, 2.35)]",
    #25
    "assert max_rain_in_3h_periods(data,'W','2021-04-09') == [(12, 0.52)]",
    #26
    "assert max_rain_in_3h_periods(data,'W','2021-04-10') == [(0, 0.28), (6, 0.21), (9, 0.21), (12, 0.98), (15, 1.55), (21, 0.9)]",
    #27
    "assert max_rain_in_3h_periods(data,'W','2021-04-11') == [(0, 1.08)]",
    #28
    "assert max_rain_in_3h_periods(data,'S','2021-04-06') == [(6, 2.46), (9, 3.96), (12, 4.76), (15, 2.28), (18, 0.85), (21, 3.42)]",
    #29
    "assert max_rain_in_3h_periods(data,'S','2021-04-07') == [(0, 1.58), (3, 2.55), (6, 5.66), (9, 1.19), (12, 1.87), (15, 1.2), (18, 0.5)]",
    #30
    "assert max_rain_in_3h_periods(data,'S','2021-04-08') == [(6, 0.31), (9, 1.06), (12, 1.62), (15, 4.75), (18, 2.08), (21, 2.79)]",
    #31
    ...
    #33
    "assert max_rain_in_3h_periods(data,'S','2021-04-11') == [(0, 0.84)]",
    #34
    "assert max_rain_in_3h_periods(data,'C','2021-04-06') == [(6, 0.75), (9, 8.96), (12, 5.54), (15, 26.08), (18, 2.21), (21, 3.57)]",
    #35
    "assert max_rain_in_3h_periods(data,'C','2021-04-07') == [(0, 3.52), (3, 1.27), (6, 0.11), (9, 0.6), (12, 0.32), (15, 2.32), (18, 1.64), (21, 2.11)]",
    #36
    "assert max_rain_in_3h_periods(data,'C','2021-04-08') == [(0, 4.32), (3, 0.12), (12, 0.12), (15, 0.26), (21, 0.12)]",
    #37
    "assert max_rain_in_3h_periods(data,'C','2021-04-09') == [(0, 0.24), (9, 0.35), (12, 0.36), (15, 0.59), (18, 0.81), (21, 0.37)]",
    #38
    "assert max_rain_in_3h_periods(data,'C','2021-04-10') == [(0, 1.94), (3, 1.26), (6, 0.48), (9, 0.13), (12, 1.34), (15, 0.66), (18, 0.36), (21, 0.14)]",
    #39
    "assert max_rain_in_3h_periods(data,'C','2021-04-11') == [(0, 0.41), (3, 2.49)]",
    #40
    "assert max_rain_in_3h_periods(data,'NE','2021-04-06') ==  [(6, 1.34), (9, 1.94), (12, 1.28), (15, 0.17), (18, 1.27), (21, 2.16)]",
    #41
    "assert max_rain_in_3h_periods(data,'NE','2021-04-07') == [(0, 2.29), (3, 0.3), (6, 0.64), (9, 0.54), (12, 0.54), (15, 0.31), (18, 1.54), (21, 0.81)]",
    #42
    "assert max_rain_in_3h_periods(data,'NE','2021-04-08') == [(0, 0.28), (21, 1.6)]",
    #43
    "assert max_rain_in_3h_periods(data,'NE','2021-04-09') == [(0, 0.85), (9, 0.1), (12, 0.13), (15, 0.62), (18, 0.19), (21, 0.88)]",
    #44
    "assert max_rain_in_3h_periods(data,'NE','2021-04-10') == [(0, 0.69), (3, 0.2), (15, 0.16)]",
    #45
    "assert max_rain_in_3h_periods(data,'NE','2021-04-11') == [(0, 0.4), (3, 0.44)]",
    #46
    "assert max_rain_in_3h_periods(data,'ALL','2021-04-06') == [(6, 6.94), (9, 8.96), (12, 5.54), (15, 26.08), (18, 3.24), (21, 3.57)]",
    #47
    ...
    #51
    "assert max_rain_in_3h_periods(data,'ALL','2021-04-11') == [(0, 2.37), (3, 2.61), ]",
    #52
